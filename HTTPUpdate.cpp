 ...
 */
 ...
 HTTPUpdateResult HTTPUpdate::update(ESP_SSLClient& client, const String& url, const String& currentVersion, HTTPUpdateRequestCB requestCB)
 {
     HTTPClient http;
 ...
 HTTPUpdateResult HTTPUpdate::updateSpiffs(ESP_SSLClient& client, const String& url, const String& currentVersion, HTTPUpdateRequestCB requestCB)
 {
     HTTPClient http;
     if(!http.begin(client, url))
     {
 ...
 HTTPUpdateResult HTTPUpdate::update(ESP_SSLClient& client, const String& host, uint16_t port, const String& uri,
         const String& currentVersion, HTTPUpdateRequestCB requestCB)
 {
     HTTPClient http;
     ...
     case HTTP_CODE_OK:  ///< OK (Start Update)
         if(len > 0) {
             ...
             if(!startUpdate) {
                 ...
                 ESP_SSLClient * tcp = http.getStreamPtr();
