 ...
 */
 ...
 public:
     ...
     t_httpUpdate_return update(ESP_SSLClient& client, const String& url, const String& currentVersion = "", HTTPUpdateRequestCB requestCB = NULL);
 
     t_httpUpdate_return update(ESP_SSLClient& client, const String& host, uint16_t port, const String& uri = "/",
                                const String& currentVersion = "", HTTPUpdateRequestCB requestCB = NULL);
 
     t_httpUpdate_return updateSpiffs(ESP_SSLClient& client, const String& url, const String& currentVersion = "", HTTPUpdateRequestCB requestCB = NULL);
